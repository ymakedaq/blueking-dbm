...
from backend.flow.utils.mysql.dts.migrate_plan import DtsMigratePlan, DtsTaskConfig, MyloaderSpec, SourceSpec, SyncScope
...
class ExpandTendbclusterSourceTest(SimpleTestCase):
    ...
    def test_expand_four_shards(self, mock_get):
        ...
        task_cfg = DtsTaskConfig(full_load_engine=FullLoadEngine.MYLOADER.value, myloader=MyloaderSpec(backup_id="bk-1"))
