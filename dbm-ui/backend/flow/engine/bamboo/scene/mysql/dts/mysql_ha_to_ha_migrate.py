...
class MysqlHaToHaMigrateFlow:
    """TenDBHA → TenDBHA 数据迁移 Flow。"""
    ...
    def run_flow(self):
        ...
        migrate_plan.migrate_type = MigrateType.HA_TO_HA.value
        ...
        pipeline.add_sub_pipeline(mysql_dts_migrate_subflow(migrate_inp).build_sub_process(sub_name=_("HA 到 HA 数据迁移")))
